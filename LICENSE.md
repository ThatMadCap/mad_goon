# License for mad_goon

This project is licensed under a custom non-commercial license.

## ✅ You Are Allowed To:

- **Use this resource** for **personal use** or **community use**, e.g, your FiveM server.
- **Modify the resource** to fit your needs.
- **Share the resource** for free.

## 🚫 You Are NOT Allowed To:

- **Sell, rent, or sublicense** this resource or any modified version of it.
- Include this resource in **paid packages** or **monetised bundles**.
